...
// POWER AND POSSIBLY RECEPTION TOO
    ...
    // Only 2 control pins are used // EbyteE77 PA6 PA7 //Wio E5 PA4 PA5

    static RH_SX126x::RadioPinConfig radioPinConfig = {
	.pinNumber = {PA6, PA7, RH_INVALID_PIN},
	.configState = {
...
#elif (RH_PLATFORM == RH_PLATFORM_ARDUINO && defined(ARDUINO_RAK3172_MODULE))
    // EG: Rak3172
    // These modules have an RF switch but only use the high power PA
    // Only 2 control pins are used

    static RH_SX126x::RadioPinConfig radioPinConfig = {
	.pinNumber = {PB8, PC13, PA9},
	.configState = {
	    {RH_SX126x::RadioPinConfigMode_IDLE,          LOW,  LOW, LOW},
	    {RH_SX126x::RadioPinConfigMode_RX,            HIGH, LOW, LOW},
	    {RH_SX126x::RadioPinConfigMode_TX_HIGH_POWER, LOW,  HIGH, HIGH}, // low power not supported on this module
	    {RH_SX126x::RadioPinConfigMode_EOT},
	}
    };	
